 ...
 \************************************************************************/
  ...
  //recall INVERSION out a 1 to ge a zero!
  {
	...
	for (loop1=0; loop1<7; loop1++)
	{
        ...
        intro_1();
//MASTER OFF
//1010011100101 0111001111100000
//222 222 222 13212 312 223 213 132 132 2221
//[ex1] 114 111 411 123 113 313 222 221 511 4111
//0100000100010000000011000
        intro_0();
        intro_1();
        intro_1();
        intro_1();
        ...
        intro_1();
        intro_1();
//1010011100101 01110011111 00000
        intro_1();
        intro_1();
        intro_0();
        intro_0();
...
//114 111 411 123 113 313 222 221 411 12311
//[ex1] 114 111 411 123 113 313 222 221 511 4111
	quintuplet();
	singlet();
	singlet();
