 ...
 \************************************************************************/
  ...
  //recall INVERSION out a 1 to ge a zero!
  {
	...
	for (loop1=0; loop1<7; loop1++)
	{
        ...
        intro_1();
        intro_1();
//10100110111111001001111111000
//222 222 222 13212 312 223 213 132 123 2221
//114 111 411 123 113 313 222 221 421 4111
//0100000100010001000011010
        ...
        intro_0();
        intro_0();
//101001101111 1100100 111 111 1 000
        intro_1();
        intro_1();
        intro_1();
        intro_1();
