...
{ 
  int g,rep,loop1,loop2,loop3,loop4,loop5,loop6;
  int plug;
  int receiver;
  char *on_or_off = NULL;
...
//Outer loop to repeat all sequences 3 times 
  for (rep=0; rep<7; rep++)
...
//prologue 
	...
	{
        usleep(3510);
//00100101110100010000 110001100
        intro_0();
        intro_0();
        intro_1();
        intro_0();
...
void chapter_1()
{
//        222 222 222 13212 312 223 213 132 222 2131
        doublet();
        doublet();
        doublet();
        ...
        singlet();
        triplet();
//       1222 222 222 13212 312 223 213 132 222 2212
//        222 222 222 13212 312 223 213 132 222 2131
